      ...
      onTap: () {
        sl<Navigation>().pushNamedWithExtra(
          ...
          navigationData: PreviewFundraiserNavigationData(
            ...
            fundraiserDescription: data.description,
            imageUrl: data.photoUrl!,
            donationsGoal: data.targetAmount.toString(),
            raisedAmount: data.receivedAmount.toString(),
            owner: data.ownerId,
            //
          ),
        );
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          data.title,
                          style: textTheme.titleMedium!.copyWith(fontSize: 15.sp, fontWeight: FontWeight.w800, color: colors.onSurface),
                        ),
